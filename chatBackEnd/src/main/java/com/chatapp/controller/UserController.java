...
public void registerUser(@RequestParam("file") MultipartFile file,@RequestParam("name") String name,@RequestParam("password") String password,@RequestParam("address") String address,@RequestParam("dob") String dob,@RequestParam("contactNo") String contactNo,@RequestParam("emailId") String emailId)
{
	...
	//D:\Chatbucketfront\WebContent\images
	
	Path path=Paths.get("D://Chatbucketfront//WebContent//images//"+name+".jpg");
	if(file!=null)
	{
		try {
